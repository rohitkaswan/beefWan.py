...
if __name__ == '__main__':
	...
	os.system("clear")	
	print (" Checking Services Status Required ","blue")
	...
	print ("\n==================================== RESULT ====================================\n","blue")
	print ("[+] Access The BeeF Control Panel Using : {}".format(connect_to_panel),"green")
	print ("\t Username = beef\n\t Password = beef\n","blue")
	print ("[+] Hooked Link To Send to Victim  : "+send_to_full,"green")
